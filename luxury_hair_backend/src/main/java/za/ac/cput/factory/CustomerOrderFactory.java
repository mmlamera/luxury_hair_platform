...
public class CustomerOrderFactory {
    public static CustomerOrder buildCustomerOrder(String orderID, int quantity, double totalPrice, String orderDate, String orderStatus, String shippingAddress, String shippingMethod, String paymentMethod) {
